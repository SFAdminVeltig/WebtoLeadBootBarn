...
<form action="https://test.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8&orgId=00DOv00000ULIO8" method="POST">
...
<label for="00NOv00000gLvG1">
    ...
    <span title="This field will be automatically set, it is only available for testing."
          style="color:#0176d3;font-weight:bold;cursor:help;">
        ⓘ
    </span>
</label>
